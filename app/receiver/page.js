            ...
            <div>
              ...
              <div className="mt-8 flex flex-col md:flex-row justify-start space-y-4 md:space-y-0 md:space-x-4">
                ...
                <div className="relative">
                  <input
                    type="text"
                    className="p-1  outline-none border-b-[1px] border-gray-500 placeholder:text-gray-800 md:w-[400px] bg-[#fbd721]"
                    placeholder="Phone number (mandatory or optional?)"
                  />
                  {/* Pointer */}
                  <div
                    className="absolute -top-3 -right-1 h-5 w-5 rounded-full bg-green-500 animate-pulse tooltip tooltip-primary tooltip-left"
                    data-tip="Making mobile number mandatory while sending to Romania from World Wide"
                  />
                </div>
              </div>
        ...
        <div className="flex-[40%] p-2 md:p-10">
          ...
          <div className="relative hidden md:flex w-fit">
            <label htmlFor="my-modal-6" className="">
              {/* Pointer */}
              <div
                className="absolute top-8 -right-1 h-5 w-5 rounded-full bg-green-500 animate-pulse tooltip tooltip-primary tooltip-left"
                data-tip="If mobile optional - show this banner"
              />
            </label>
            {/* UPSELLLLLLLLLL ???  */}
